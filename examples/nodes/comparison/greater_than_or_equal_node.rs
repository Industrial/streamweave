...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  graph.expose_input_port("greater_than_or_equal", "in2", "in2")?;
  graph.expose_output_port("greater_than_or_equal", "out", "output")?;
  graph.expose_output_port("greater_than_or_equal", "error", "error")?;
  ...
  println!("✓ Graph built with GreaterThanOrEqualNode using Graph API");
