...
- Identify where the tests should live (e.g., `__tests__`, `test/`, `*_spec.ts`, etc.).
...
- Prefer data-driven tests (tables/loops) when possible.
...
### 🟢 Step 7: Commit the Code and Update `TODO.md`
...
- Add or update JSDoc/TSDoc, docstrings, or comments as appropriate
