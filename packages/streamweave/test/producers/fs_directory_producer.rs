...
#[tokio::test]
async fn test_fs_directory_producer_basic() {
...
#[tokio::test]
async fn test_fs_directory_producer_recursive() {
  let temp_dir = std::env::temp_dir();
...
#[tokio::test]
async fn test_fs_directory_producer_nonexistent() {
...
#[tokio::test]
async fn test_fs_directory_producer_with_name() {
...
#[tokio::test]
async fn test_fs_directory_producer_with_error_strategy() {
  let producer =
...
#[tokio::test]
async fn test_fs_directory_producer_component_info() {
