...
#[test]
fn test_stdio_stderr_consumer_new() {
...
#[test]
fn test_stdio_stderr_consumer_default() {
  let consumer = StdioStderrConsumer::<String>::default();
  // Default consumer should be created
  assert!(true);
}

#[test]
fn test_stdio_stderr_consumer_with_name() {
  let consumer = StdioStderrConsumer::<String>::new().with_name("stderr".to_string());

  assert_eq!(consumer.config.name, "stderr");
}

#[test]
fn test_stdio_stderr_consumer_with_error_strategy() {
  let consumer = StdioStderrConsumer::<String>::new().with_error_strategy(ErrorStrategy::Skip);
...
#[test]
fn test_stdio_stderr_consumer_config_operations() {
  let mut consumer = StdioStderrConsumer::<String>::new();
...
#[test]
fn test_stdio_stderr_consumer_component_info() {
