...
/// use streamweave::graph::deserialize;
///
...
/// ```rust
/// use bytes::Bytes;
/// use streamweave::graph::{serialize, deserialize};
/// use streamweave::message::wrap_message;
///
/// let msg = wrap_message(42i32);
/// let bytes = serialize(&msg)?;
/// let deserialized: streamweave::message::Message<i32> = deserialize(bytes)?;
/// assert_eq!(*deserialized.payload(), 42);
/// # Ok::<(), streamweave::graph::SerializationError>(())
/// ```
...
///
/// ```rust
/// use streamweave::graph::serialization::ZeroCopyDeserializer;
/// use bytes::Bytes;
///
...
/// let deserialized: streamweave::message::Message<i32> = deserializer.deserialize()?;
/// assert_eq!(*deserialized.payload(), 42);
/// # Ok::<(), streamweave::graph::SerializationError>(())
/// ```
#[derive(Debug, Clone)]
...
///
/// ```rust
/// use streamweave::graph::serialization::deserialize_zero_copy_strings;
///
