...
///
/// ```rust
/// use streamweave::graph::control_flow::{Match, Pattern, RangePattern};
///
...
///
/// ```rust
/// use streamweave::graph::control_flow::{Pattern, RangePattern};
///
...
///
/// ```rust
/// use streamweave::graph::control_flow::{Pattern, PredicatePattern};
///
