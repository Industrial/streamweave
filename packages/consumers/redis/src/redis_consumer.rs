...
///
/// ```ignore
/// use streamweave::consumers::redis::{RedisConsumer, RedisProducerConfig};
/// use serde::Serialize;
///
/// #[derive(Serialize)]
/// struct Event {
...
mod tests {
  ...
  proptest! {
    #[test]
    fn test_redis_producer_config_default(_ in prop::num::u8::ANY) {
    ...
    #[test]
    fn test_redis_producer_config_builder(
