...
///
/// ```rust
/// use streamweave::graph::control_flow::GraphVariables;
///
...
///
/// ```rust
/// use streamweave::graph::control_flow::{GraphVariables, ReadVariable};
...
///
/// ```rust
/// use streamweave::graph::control_flow::{GraphVariables, WriteVariable};
/// use streamweave::graph::node::TransformerNode;
///
/// let vars = GraphVariables::new();
