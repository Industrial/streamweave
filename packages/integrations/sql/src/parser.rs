...
use streamweave_error::{ComponentInfo, ErrorContext, StreamError, StringError};
...
impl SqlParser {
  ...
  pub fn parse(&self, query: &str) -> Result<SqlQuery, Box<StreamError<String>>> {
    ...
    parser = parser
      .try_with_sql(query)
      .map_err(|e| Box::new(parser_error_to_stream_error(e)))?;
    let ast = parser
      .parse_statement()
      .map_err(|e| Box::new(parser_error_to_stream_error(e)))?;
    ...
    let order_by = if query.order_by.is_empty() {
      ...
      Some(OrderByClause {
        items: query
          ...
          .iter()
          .map(
            |item| -> Result<crate::ast::OrderByItem, StreamError<String>> {
              Ok(OrderByItem {
  ...
  ) -> Result<crate::ast::SelectItem, StreamError<String>> {
    match item {
      sqlparser::ast::SelectItem::UnnamedExpr(expr) => Ok(crate::ast::SelectItem::Expression {
      ...
      sqlparser::ast::SelectItem::Wildcard(_) => Ok(crate::ast::SelectItem::All),
      sqlparser::ast::SelectItem::QualifiedWildcard(_, _) => Ok(crate::ast::SelectItem::All),
    }
  }
    ...
    match expr {
      ...
      Expr::Case {
        ...
        let cases = conditions
          ...
          .map(
            |(cond, result)| -> Result<
              (crate::ast::Expression, crate::ast::Expression),
              StreamError<String>,
      ...
      Expr::IsNull(expr) => Ok(Expression::BinaryOp {
        ...
        op: crate::ast::BinaryOperator::IsNull,
        right: Box::new(Expression::Literal(crate::ast::Literal::Null)),
      }),
      Expr::IsNotNull(expr) => Ok(Expression::BinaryOp {
        left: Box::new(self.convert_expr(expr)?),
        op: crate::ast::BinaryOperator::IsNotNull,
        right: Box::new(Expression::Literal(crate::ast::Literal::Null)),
      }),
  ...
  ) -> Result<crate::ast::BinaryOperator, StreamError<String>> {
    match op {
      sqlparser::ast::BinaryOperator::Plus => Ok(crate::ast::BinaryOperator::Add),
      sqlparser::ast::BinaryOperator::Minus => Ok(crate::ast::BinaryOperator::Subtract),
      sqlparser::ast::BinaryOperator::Multiply => Ok(crate::ast::BinaryOperator::Multiply),
      sqlparser::ast::BinaryOperator::Divide => Ok(crate::ast::BinaryOperator::Divide),
      sqlparser::ast::BinaryOperator::Modulo => Ok(crate::ast::BinaryOperator::Modulo),
      sqlparser::ast::BinaryOperator::Eq => Ok(crate::ast::BinaryOperator::Eq),
      sqlparser::ast::BinaryOperator::NotEq => Ok(crate::ast::BinaryOperator::Ne),
      sqlparser::ast::BinaryOperator::Lt => Ok(crate::ast::BinaryOperator::Lt),
      sqlparser::ast::BinaryOperator::LtEq => Ok(crate::ast::BinaryOperator::Le),
      sqlparser::ast::BinaryOperator::Gt => Ok(crate::ast::BinaryOperator::Gt),
      sqlparser::ast::BinaryOperator::GtEq => Ok(crate::ast::BinaryOperator::Ge),
      sqlparser::ast::BinaryOperator::And => Ok(crate::ast::BinaryOperator::And),
      sqlparser::ast::BinaryOperator::Or => Ok(crate::ast::BinaryOperator::Or),
  ...
  ) -> Result<crate::ast::UnaryOperator, StreamError<String>> {
    match op {
      sqlparser::ast::UnaryOperator::Not => Ok(crate::ast::UnaryOperator::Not),
      sqlparser::ast::UnaryOperator::Minus => Ok(crate::ast::UnaryOperator::Minus),
      sqlparser::ast::UnaryOperator::Plus => Ok(crate::ast::UnaryOperator::Plus),
...
// Helper function to convert sqlparser::parser::ParserError to StreamError
fn parser_error_to_stream_error(err: sqlparser::parser::ParserError) -> StreamError<String> {
  StreamError::new(
