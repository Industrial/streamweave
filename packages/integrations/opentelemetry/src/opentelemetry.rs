...
impl OpenTelemetryConfig {
  ...
  pub async fn init_tracer(&self) -> Result<SdkTracer, TraceError> {
    ...
    // For opentelemetry-otlp 0.31, use SpanExporterBuilder::new().with_tonic().build()
  ...
  pub async fn init_meter(
    ...
    // For opentelemetry-otlp 0.31, use MetricExporterBuilder::new().with_tonic().build()
...
/// # }
/// ```
#[cfg(all(feature = "opentelemetry", feature = "metrics"))]
...
impl MetricsExporter {
  ...
  /// # }
  /// ```
  pub async fn export_metrics(&self, metrics: &streamweave_metrics::types::PipelineMetrics) {
