...
#[test]
fn test_stdin_producer_with_name() {
  let producer = StdinProducer::new().with_name("stdin".to_string());
...
#[test]
fn test_stdin_producer_with_error_strategy() {
  let producer = StdinProducer::new().with_error_strategy(ErrorStrategy::Skip);
...
#[test]
fn test_stdin_producer_config_operations() {
...
#[test]
fn test_stdin_producer_component_info() {
