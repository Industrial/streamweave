//! Comprehensive tests for DbMysqlProducer
//!
...
use streamweave::producers::DbDbMysqlProducer;
...
async fn test_mysql_producer_new() {
  ...
  let producer = DbMysqlProducer::new(config.clone());
...
async fn test_mysql_producer_with_error_strategy() {
  ...
  let producer = DbMysqlProducer::new(config).with_error_strategy(ErrorStrategy::Skip);
...
async fn test_mysql_producer_with_name() {
  ...
  let producer = DbMysqlProducer::new(config).with_name("test_producer".to_string());
...
async fn test_mysql_producer_clone() {
  ...
  let producer = DbMysqlProducer::new(config).with_name("test".to_string());
...
async fn test_mysql_producer_produce_simple_query() {
  ...
  let mut producer = DbMysqlProducer::new(config);
