...
- [ ] 0.1.1 Add `configuration` port to AndNode
...
- [ ] 0.1.3 Add `configuration` port to NotNode
...
- [ ] 0.1.4 Add `configuration` port to XorNode
...
- [ ] 0.1.5 Add `configuration` port to NandNode
...
- [ ] 1.4.2 Implement ReadVariableNode - Read variable value
...
- [ ] 1.5.3 Add synchronization node tests
...
- [ ] 2.1.2 Implement SubtractNode - Subtraction
...
- [ ] 2.1.4 Implement DivideNode - Division
...
- [ ] 2.2.2 Implement NotEqualNode - Inequality comparison
...
- [ ] 2.2.4 Implement GreaterThanOrEqualNode - Greater than or equal
...
- [ ] 2.2.5 Implement LessThanNode - Less than
...
- [ ] 2.2.6 Implement LessThanOrEqualNode - Less than or equal
...
- [ ] 2.3.2 Implement MinNode - Minimum of two values
...
- [ ] 2.3.3 Implement MaxNode - Maximum of two values
...
- [ ] 2.3.7 Implement SqrtNode - Square root
...
- [ ] 2.3.8 Implement LogNode - Logarithm
...
- [ ] 3.1.2 Implement StringLengthNode - Get string length
...
- [ ] 3.1.3 Implement StringSliceNode - Extract substring
...
- [ ] 3.1.6 Implement StringJoinNode - Join array into string
...
- [ ] 3.1.7 Add basic string operation tests
...
- [ ] 3.2.5 Implement StringEqualNode - String equality
...
- [ ] 3.3.5 Add string transformation tests
  - **File:** `src/graph/nodes/string/*_test.rs`
  - **Acceptance Criteria:**
...
- [ ] 4.2.3 Implement ArraySortNode - Sort array
...
- [ ] 4.2.6 Add array transformation tests
  - **File:** `src/graph/nodes/array/*_test.rs`
  - **Acceptance Criteria:**
    - Tests for each transformation
    - Tests for edge cases
...
- [ ] 4.3.5 Add array operation tests
  - **File:** `src/graph/nodes/array/*_test.rs`
  - **Acceptance Criteria:**
    - Tests for each operation
    - Tests for edge cases
...
- [ ] 5.1.3 Implement ObjectEntriesNode - Get key-value pairs
...
- [ ] 5.1.4 Implement ObjectPropertyNode - Get property value
...
- [ ] 6.2.3 Implement AggregateNode - General aggregation
...
- [ ] 7.1.2 Implement TimeoutNode - Apply timeout
...
- [ ] 7.1.5 Add time operation tests
...
- [ ] 8.2.4 Add stream combination tests
  - **File:** `src/graph/nodes/stream/*_test.rs`
  - **Acceptance Criteria:**
    - Tests for each operation
    - Tests for edge cases
...
- [ ] 9.1.3 Implement IsStringNode - Check if string
...
- [ ] 9.1.4 Implement IsBooleanNode - Check if boolean
...
- [ ] 9.1.5 Implement IsArrayNode - Check if array
...
- [ ] 9.1.6 Implement IsObjectNode - Check if object
...
- [ ] 9.1.7 Implement IsNullNode - Check if null
...
- [ ] 9.2.5 Add type conversion tests
  - **File:** `src/graph/nodes/type_ops/*_test.rs`
  - **Acceptance Criteria:**
...
- [ ] 10.1.3 Implement ContinueNode - Continue loop iteration
...
- [ ] 10.2.4 Add advanced control tests
  - **File:** `src/graph/nodes/advanced/*_test.rs`
  - **Acceptance Criteria:**
    - Tests for each operation
    - Tests for edge cases
