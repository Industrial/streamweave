...
use crate::distributed::coordinator::{Coordinator, CoordinatorError, WorkerInfo};
use crate::distributed::fault_tolerance::checkpoint::{
...
mod tests {
  use super::*;
  use crate::distributed::fault_tolerance::checkpoint::InMemoryCheckpointStore;
