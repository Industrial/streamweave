//! Tests for StringLowercaseNode

use crate::node::{InputStreams, Node};
use crate::nodes::string::StringLowercaseNode;
use std::any::Any;
...
#[tokio::test]
async fn test_string_lowercase_node_creation() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
  assert_eq!(node.name(), "test_lowercase");
...
#[tokio::test]
async fn test_string_lowercase_basic() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
...
#[tokio::test]
async fn test_string_lowercase_already_lowercase() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
  ...
  // Send value: "hello" -> "hello" (already lowercase)
  let _ = in_tx
    .send(Arc::new("hello".to_string()) as Arc<dyn Any + Send + Sync>)
    .await;
...
#[tokio::test]
async fn test_string_lowercase_empty() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
...
#[tokio::test]
async fn test_string_lowercase_mixed_case() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
...
#[tokio::test]
async fn test_string_lowercase_unicode() {
  let node = StringLowercaseNode::new("test_lowercase".to_string());
  ...
  // Send value: "ÑANDÚ" -> "ñandú" (Unicode lowercase)
  let _ = in_tx
