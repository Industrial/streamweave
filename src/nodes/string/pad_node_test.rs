...
use crate::nodes::string::StringPadNode;
use std::any::Any;
...
fn create_input_streams() -> (
  ...
  inputs.insert(
    "length".to_string(),
    Box::pin(ReceiverStream::new(length_rx)) as crate::node::InputStream,
  );
  inputs.insert(
    "padding".to_string(),
    Box::pin(ReceiverStream::new(padding_rx)) as crate::node::InputStream,
  );
  inputs.insert(
    "side".to_string(),
    Box::pin(ReceiverStream::new(side_rx)) as crate::node::InputStream,
  );
