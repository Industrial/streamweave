...
use crate::nodes::string::StringReplaceNode;
use std::any::Any;
...
fn create_input_streams() -> (
  ...
  inputs.insert(
    "pattern".to_string(),
    Box::pin(ReceiverStream::new(pattern_rx)) as crate::node::InputStream,
  );
  inputs.insert(
    "replacement".to_string(),
    Box::pin(ReceiverStream::new(replacement_rx)) as crate::node::InputStream,
  );
