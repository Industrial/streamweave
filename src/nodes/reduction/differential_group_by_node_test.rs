...
use crate::nodes::reduction::{GroupByConfigWrapper, group_by_config};
...
async fn test_differential_group_by_count() {
  ...
  in_tx
    .send(Arc::new(DifferentialStreamMessage::Data(
      DifferentialElement::insert(
