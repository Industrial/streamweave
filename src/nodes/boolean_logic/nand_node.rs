//! # Nand Node
//!
//! A transform node that performs logical NAND (NOT AND) operation on two boolean inputs.
//!
//! ## Ports
//!
...
/// A node that performs logical NAND operation on two boolean inputs.
///
...
impl NandNode {
  /// Creates a new NandNode with the given name.
