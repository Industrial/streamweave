//! # Xor Node
//!
//! A transform node that performs logical XOR (exclusive OR) operation on two boolean inputs.
//!
//! ## Ports
//!
...
//! - **Output**: `"out"` - Sends the result of (in1 XOR in2)
...
/// A node that performs logical XOR operation on two boolean inputs.
///
...
impl XorNode {
  /// Creates a new XorNode with the given name.
