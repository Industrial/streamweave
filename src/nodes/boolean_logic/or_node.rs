//! # Or Node
//!
//! A transform node that performs logical OR operation on two boolean inputs.
//!
//! ## Ports
//!
...
//! - **Output**: `"out"` - Sends the result of (in1 OR in2)
...
/// A node that performs logical OR operation on two boolean inputs.
///
/// The node receives two boolean values on "in1" and "in2" ports and outputs
/// the result of the OR operation to the "out" port.
pub struct OrNode {
  pub(crate) base: BaseNode,
}

impl OrNode {
  /// Creates a new OrNode with the given name.
