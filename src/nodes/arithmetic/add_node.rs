//! # Add Node
//!
//! A transform node that performs addition on two numeric inputs.
//!
//! ## Ports
//!
...
//! ## Behavior
//!
//! The node performs addition on two numeric values. It supports:
...
/// A node that performs addition on two numeric inputs.
///
...
impl AddNode {
  /// Creates a new AddNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  ...
  ///
  /// let node = AddNode::new("add".to_string());
