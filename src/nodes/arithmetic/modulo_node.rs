//! # Modulo Node
//!
//! A transform node that performs modulo operation on two numeric inputs.
//!
//! ## Ports
//!
...
//! ## Behavior
//!
//! The node performs modulo operation on two numeric values. It supports:
...
use crate::nodes::arithmetic::common::modulo_values;
...
/// A node that performs modulo operation on two numeric inputs.
///
...
impl ModuloNode {
  /// Creates a new ModuloNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  ...
  ///
  /// let node = ModuloNode::new("modulo".to_string());
