...
use crate::nodes::join_node::{join_config, JoinStrategy};
...
fn to_differential(payload: Arc<dyn Any + Send + Sync>, time: u64, diff: i64) -> Arc<dyn Any + Send + Sync> {
