...
//!
//! ```rust,no_run
//! use crate::metrics::health::{HealthCheck, HealthStatus, ComponentHealth};
//!
...
///
/// ```rust
/// use crate::metrics::health::HealthStatus;
///
...
///
/// ```rust
/// use crate::metrics::health::ComponentHealth;
///
...
///
/// ```rust,no_run
/// use crate::metrics::health::{HealthCheck, ComponentHealth};
///
/// # async fn example() -> Result<(), Box<dyn std::error::Error>> {
/// let mut health_check = HealthCheck::new("my-pipeline");
///
...
impl HealthCheck {
  ...
  ///
  /// ```rust
  /// use crate::metrics::health::HealthCheck;
  ///
