...
//! use crate::graph::node::{ProducerNode, TransformerNode};
...
///
/// ```rust
/// use crate::graph::connection::HasOutputPort;
///
...
///
/// ```rust
/// use crate::graph::connection::HasInputPort;
///
...
///
/// ```rust
/// use crate::graph::connection::CompatibleWith;
///
