//! Tests for GreaterThanOrEqualNode

use crate::graph::node::{InputStreams, Node};
use crate::graph::nodes::comparison::GreaterThanOrEqualNode;
use std::any::Any;
...
#[tokio::test]
async fn test_greater_than_or_equal_node_creation() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
  assert_eq!(node.name(), "test_greater_than_or_equal");
...
#[tokio::test]
async fn test_greater_than_or_equal_node_i32_greater() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_i32_equal() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_i32_less() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_f64_greater() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_f64_equal() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_f64_less() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_type_promotion_i32_to_i64() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_type_promotion_i32_to_f64() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_incompatible_types() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_u32() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_f32() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_negative_values() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_i64() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
...
#[tokio::test]
async fn test_greater_than_or_equal_node_u64() {
  let node = GreaterThanOrEqualNode::new("test_greater_than_or_equal".to_string());
