//! Tests for LessThanOrEqualNode

use crate::graph::node::{InputStreams, Node};
use crate::graph::nodes::comparison::LessThanOrEqualNode;
use std::any::Any;
...
#[tokio::test]
async fn test_less_than_or_equal_node_creation() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
  assert_eq!(node.name(), "test_less_than_or_equal");
...
#[tokio::test]
async fn test_less_than_or_equal_node_i32_less() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_i32_equal() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_i32_greater() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_f64_less() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_f64_equal() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_f64_greater() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_type_promotion_i32_to_i64() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_type_promotion_i32_to_f64() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
  ...
  // Send values: i32 <= f64 (5 <= 10.0) = true
  let _ = in1_tx
    .send(Arc::new(5i32) as Arc<dyn Any + Send + Sync>)
    .await;
  let _ = in2_tx
...
#[tokio::test]
async fn test_less_than_or_equal_node_incompatible_types() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_u32() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_f32() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_negative_values() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
  ...
  // Send values: -10 <= -5 = true (negative comparison)
  let _ = in1_tx
    .send(Arc::new(-10i32) as Arc<dyn Any + Send + Sync>)
    .await;
  let _ = in2_tx
...
#[tokio::test]
async fn test_less_than_or_equal_node_i64() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
...
#[tokio::test]
async fn test_less_than_or_equal_node_u64() {
  let node = LessThanOrEqualNode::new("test_less_than_or_equal".to_string());
