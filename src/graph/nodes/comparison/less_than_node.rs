//! # Less Than Node
//!
//! A transform node that performs less than comparison on two inputs.
//!
//! ## Ports
//!
...
//! ## Behavior
//!
//! The node performs less than comparison on two values. It supports:
...
use crate::graph::nodes::comparison::common::compare_less_than;
...
/// A node that performs less than comparison on two inputs.
///
...
impl LessThanNode {
  /// Creates a new LessThanNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::comparison::LessThanNode;
  ///
  /// let node = LessThanNode::new("less_than".to_string());
