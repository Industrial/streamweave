//! Tests for LessThanNode

use crate::graph::node::{InputStreams, Node};
use crate::graph::nodes::comparison::LessThanNode;
use std::any::Any;
...
#[tokio::test]
async fn test_less_than_node_creation() {
  let node = LessThanNode::new("test_less_than".to_string());
  assert_eq!(node.name(), "test_less_than");
...
#[tokio::test]
async fn test_less_than_node_i32_true() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_i32_false() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_i32_equal() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_f64_true() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_f64_false() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_type_promotion_i32_to_i64() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_type_promotion_i32_to_f64() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_incompatible_types() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_u32() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_f32() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_negative_values() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_i64() {
  let node = LessThanNode::new("test_less_than".to_string());
...
#[tokio::test]
async fn test_less_than_node_u64() {
  let node = LessThanNode::new("test_less_than".to_string());
