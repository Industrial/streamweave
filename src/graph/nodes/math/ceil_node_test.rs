...
use crate::graph::nodes::math::CeilNode;
use std::any::Any;
...
#[tokio::test]
async fn test_ceil_node_creation() {
  let node = CeilNode::new("test_ceil".to_string());
  assert_eq!(node.name(), "test_ceil");
...
async fn test_ceil_node_i64() {
  ...
  // Send value: ceil(100_000_000_000i64) = 100_000_000_000i64
  let _ = in_tx
...
async fn test_ceil_node_u64() {
  ...
  // Send value: ceil(1_000_000_000_000u64) = 1_000_000_000_000u64
  let _ = in_tx
...
#[tokio::test]
async fn test_ceil_node_f32_positive() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_f32_exact() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_f64_positive() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_f64_exact() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_f64_negative() {
  let node = CeilNode::new("test_ceil".to_string());
  ...
  // Send value: ceil(-3.6f64) = -3 (smallest integer >= -3.6)
  let _ = in_tx
    .send(Arc::new(-3.6f64) as Arc<dyn Any + Send + Sync>)
    .await;
...
#[tokio::test]
async fn test_ceil_node_f64_negative_exact() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_f64_zero() {
  let node = CeilNode::new("test_ceil".to_string());
...
#[tokio::test]
async fn test_ceil_node_unsupported_type() {
  let node = CeilNode::new("test_ceil".to_string());
  ...
  assert!(errors[0].contains("Unsupported type for ceil"));
}
