...
use crate::graph::nodes::math::MaxNode;
use std::any::Any;
...
#[tokio::test]
async fn test_max_node_creation() {
  let node = MaxNode::new("test_max".to_string());
...
#[tokio::test]
async fn test_max_node_i32_equal() {
  let node = MaxNode::new("test_max".to_string());
...
async fn test_max_node_i64() {
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 100i64);
}

#[tokio::test]
async fn test_max_node_u32() {
  let node = MaxNode::new("test_max".to_string());
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 10u32);
}

#[tokio::test]
async fn test_max_node_u64() {
  let node = MaxNode::new("test_max".to_string());
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 100u64);
}

#[tokio::test]
async fn test_max_node_f32() {
  let node = MaxNode::new("test_max".to_string());
...
async fn test_max_node_f64() {
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 3.5f64);
}

#[tokio::test]
async fn test_max_node_type_promotion_i32_to_i64() {
  let node = MaxNode::new("test_max".to_string());
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 10i64);
}

#[tokio::test]
async fn test_max_node_type_promotion_i32_to_f64() {
  let node = MaxNode::new("test_max".to_string());
  ...
  assert_eq!(results.len(), 1);
  assert_eq!(results[0], 10.0f64);
}

#[tokio::test]
async fn test_max_node_unsupported_type() {
  let node = MaxNode::new("test_max".to_string());
  ...
  assert!(errors[0].contains("Unsupported types for maximum"));
}

#[tokio::test]
async fn test_max_node_negative_values() {
  let node = MaxNode::new("test_max".to_string());
...
#[tokio::test]
async fn test_max_node_f32_negative() {
  let node = MaxNode::new("test_max".to_string());
