...
use crate::graph::nodes::math::AbsNode;
use std::any::Any;
...
#[tokio::test]
async fn test_abs_node_creation() {
  let node = AbsNode::new("test_abs".to_string());
  assert_eq!(node.name(), "test_abs");
...
#[tokio::test]
async fn test_abs_node_i32_positive() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_i32_negative() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_i32_zero() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_i64_positive() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_i64_negative() {
  let node = AbsNode::new("test_abs".to_string());
...
async fn test_abs_node_u32() {
  ...
  // Send value: abs(5) = 5 (unsigned is already non-negative)
  let _ = in_tx
...
async fn test_abs_node_u64() {
  ...
  // Send value: abs(100) = 100 (unsigned is already non-negative)
  let _ = in_tx
...
#[tokio::test]
async fn test_abs_node_f32_positive() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_f32_negative() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_f64_positive() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_f64_negative() {
  let node = AbsNode::new("test_abs".to_string());
...
#[tokio::test]
async fn test_abs_node_unsupported_type() {
  let node = AbsNode::new("test_abs".to_string());
