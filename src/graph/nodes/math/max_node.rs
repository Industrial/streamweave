//! # Maximum Node
//!
//! A transform node that computes the maximum of two numeric inputs.
//!
//! ## Ports
//!
...
//! - **Output**: `"out"` - Sends the maximum of the two inputs
//! - **Output**: `"error"` - Sends errors that occur during processing (e.g., type mismatch)
//!
//! ## Behavior
//!
//! The node computes the maximum of two numeric inputs. It supports:
...
use crate::graph::nodes::math::common::max_values;
...
/// A node that computes the maximum of two numeric inputs.
///
...
impl MaxNode {
  /// Creates a new MaxNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::math::MaxNode;
  ///
  /// let node = MaxNode::new("max".to_string());
