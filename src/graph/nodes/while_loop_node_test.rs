...
use crate::graph::nodes::while_loop_node::{WhileLoopConfig, WhileLoopNode, while_loop_config};
use std::any::Any;
...
fn create_input_streams() -> (
  ...
  inputs.insert(
    "condition".to_string(),
    Box::pin(ReceiverStream::new(break_rx)) as crate::graph::node::InputStream,
  );
...
#[tokio::test]
#[ignore] // TODO: Fix timing issue with break signal
