...
use crate::graph::nodes::arithmetic::MultiplyNode;
use std::any::Any;
...
#[tokio::test]
async fn test_multiply_node_creation() {
  let node = MultiplyNode::new("test_multiply".to_string());
  assert_eq!(node.name(), "test_multiply");
...
#[tokio::test]
async fn test_multiply_node_i32() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_i64() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_f64() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_type_promotion_i32_to_i64() {
  let node = MultiplyNode::new("test_multiply".to_string());
  ...
  let _ = in1_tx
    ...
    .await;
  let _ = in2_tx
    .send(Arc::new(6i64) as Arc<dyn Any + Send + Sync>)
    .await;
...
#[tokio::test]
async fn test_multiply_node_type_promotion_i32_to_f32() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_overflow() {
  let node = MultiplyNode::new("test_multiply".to_string());
  ...
  // Send values that will overflow i32: i32::MAX * 2
  let _ = in1_tx
...
#[tokio::test]
async fn test_multiply_node_unsupported_type() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_u32() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_u64() {
  let node = MultiplyNode::new("test_multiply".to_string());
  ...
  // Send values: 10 * 20 = 200
  let _ = in1_tx
    .send(Arc::new(10u64) as Arc<dyn Any + Send + Sync>)
    .await;
  let _ = in2_tx
    .send(Arc::new(20u64) as Arc<dyn Any + Send + Sync>)
    .await;
...
#[tokio::test]
async fn test_multiply_node_f32() {
  let node = MultiplyNode::new("test_multiply".to_string());
...
#[tokio::test]
async fn test_multiply_node_zero() {
  let node = MultiplyNode::new("test_multiply".to_string());
