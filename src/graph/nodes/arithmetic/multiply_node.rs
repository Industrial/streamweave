//! # Multiply Node
//!
//! A transform node that performs multiplication on two numeric inputs.
//!
//! ## Ports
//!
...
//! ## Behavior
//!
//! The node performs multiplication on two numeric values. It supports:
...
use crate::graph::nodes::arithmetic::common::multiply_values;
...
/// A node that performs multiplication on two numeric inputs.
///
/// The node receives two numeric values on "in1" and "in2" ports and outputs
/// the result of the multiplication to the "out" port.
pub struct MultiplyNode {
  pub(crate) base: BaseNode,
}

impl MultiplyNode {
  /// Creates a new MultiplyNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::arithmetic::MultiplyNode;
  ///
  /// let node = MultiplyNode::new("multiply".to_string());
