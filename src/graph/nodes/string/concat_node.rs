//! # String Concat Node
//!
//! A transform node that concatenates two string inputs.
//!
//! ## Ports
//!
...
//! - **Output**: `"out"` - Sends the concatenated result (in1 + in2)
//! - **Output**: `"error"` - Sends errors that occur during processing (e.g., type mismatch)
//!
//! ## Behavior
//!
//! The node concatenates two string values. It supports:
...
use crate::graph::nodes::string::common::concat_strings;
...
/// A node that concatenates two string inputs.
///
...
impl StringConcatNode {
  /// Creates a new StringConcatNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::string::StringConcatNode;
  ///
  /// let node = StringConcatNode::new("concat".to_string());
...
#[async_trait]
impl Node for StringConcatNode {
  fn name(&self) -> &str {
    self.base.name()
  }
