//! # Array Contains Node
//!
//! A transform node that checks if an array contains a value.
//!
//! ## Ports
//!
...
//! ## Behavior
//!
//! The node checks if an array contains a value and returns a boolean. It supports:
...
use crate::graph::nodes::array::common::array_contains;
...
/// A node that checks if an array contains a value.
///
...
impl ArrayContainsNode {
  /// Creates a new ArrayContainsNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::array::ArrayContainsNode;
  ///
  /// let node = ArrayContainsNode::new("contains".to_string());
...
#[async_trait]
impl Node for ArrayContainsNode {
  fn name(&self) -> &str {
    self.base.name()
  }
