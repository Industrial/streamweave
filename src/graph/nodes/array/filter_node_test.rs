...
use crate::graph::nodes::array::ArrayFilterNode;
use crate::graph::nodes::{FilterConfig, filter_config};
use std::any::Any;
...
fn create_input_streams() -> (
  ...
  inputs.insert(
    "predicate".to_string(),
    Box::pin(ReceiverStream::new(predicate_rx)) as crate::graph::node::InputStream,
  );
