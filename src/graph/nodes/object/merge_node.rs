//! # Object Merge Node
//!
//! A transform node that merges two objects (HashMaps).
//!
//! ## Ports
//!
//! - **Input**: `"configuration"` - Receives configuration (currently unused, for consistency)
//! - **Input**: `"in1"` - Receives first object value (HashMap<String, Arc<dyn Any + Send + Sync>>)
//! - **Input**: `"in2"` - Receives second object value (HashMap<String, Arc<dyn Any + Send + Sync>>)
//! - **Output**: `"out"` - Sends the merged object
//! - **Output**: `"error"` - Sends errors that occur during processing (e.g., type mismatch)
//!
//! ## Behavior
//!
//! The node merges two objects and returns the result. It supports:
...
use crate::graph::nodes::object::common::object_merge;
...
/// A node that merges two objects.
///
...
impl ObjectMergeNode {
  /// Creates a new ObjectMergeNode with the given name.
  ///
  /// # Example
  ///
  /// ```rust,no_run
  /// use streamweave::graph::nodes::object::ObjectMergeNode;
  ///
  /// let node = ObjectMergeNode::new("merge".to_string());
