...
use crate::graph::nodes::join_node::{JoinNode, JoinStrategy, join_config};
use std::any::Any;
...
fn create_input_streams() -> (
  ...
  inputs.insert(
    "left".to_string(),
    Box::pin(ReceiverStream::new(left_rx)) as crate::graph::node::InputStream,
  );
  inputs.insert(
    "right".to_string(),
    Box::pin(ReceiverStream::new(right_rx)) as crate::graph::node::InputStream,
  );
