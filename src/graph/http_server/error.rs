...
//!
//! ```rust,no_run
//! use crate::http_server::error::{map_to_http_error, ErrorResponse};
...
///
/// ```rust,no_run
/// use crate::http_server::error::ErrorResponse;
/// use axum::http::StatusCode;
///
...
///
/// ```rust,no_run
/// use crate::http_server::error::map_to_http_error;
...
///
/// ```rust,no_run
/// use crate::http_server::error::map_generic_error;
/// use axum::http::StatusCode;
///
...
///
/// ```rust,no_run
/// use crate::http_server::error::create_custom_error;
/// use axum::http::StatusCode;
///
