...
pub struct ThrottleTransformer<T> {
  duration: Duration,
  config: TransformerConfig,
  _phantom: std::marker::PhantomData<T>,
}

impl<T> ThrottleTransformer<T>
where
  T: Send + 'static,
{
...
impl<T> crate::traits::error::Error for ThrottleTransformer<T>
where
  T: Send + 'static,
{
...
impl<T> Input for ThrottleTransformer<T>
where
  T: Send + 'static,
{
  type Input = T;
...
impl<T> Output for ThrottleTransformer<T>
where
  T: Send + 'static,
{
  type Output = T;
...
#[async_trait]
impl<T> Transformer for ThrottleTransformer<T>
where
  T: Send + 'static,
{
