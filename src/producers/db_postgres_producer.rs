...
impl Clone for DbPostgresProducer {
  fn clone(&self) -> Self {
    Self {
...
impl Producer for DbPostgresProducer {
  ...
  fn produce(&mut self) -> Self::OutputStream {
    ...
    let component_name = self
      ...
      .name
      .clone()
      .unwrap_or_else(|| "db_postgres_producer".to_string());
