...
//!
//! ```rust
//! use crate::message::{Message, MessageId, wrap_message};
//!
...
impl MessageMetadata {
  ...
  /// is provided by `crate::graph::StringInterner`. For use with the graph
  /// module, pass a `&StringInterner` from `crate::graph`.
  #[must_use]
...
///
/// ```rust
/// use crate::message::{Message, MessageId, MessageMetadata, wrap_message};
///
...
///
/// ```rust
/// use crate::message::{wrap_message, Message};
/// use std::sync::Arc;
///
/// let msg = wrap_message(42);
...
///
/// ```rust
/// use crate::message::{IdGenerator, UuidGenerator, SequenceGenerator};
///
/// // UUID generator
...
///
/// ```rust,no_run
/// use crate::message::{IdGenerator, MessageId};
///
...
///
/// ```rust
/// use crate::message::{Message, MessageId, SharedMessage};
///
/// let msg = Message::new(42, MessageId::new_uuid());
...
// blanket implementation in crate::graph for all types that are
...
/// `MessageMetadata` to work with any interner type. The `crate::graph`
...
///
/// ```rust
/// use crate::message::{wrap_message_with_id, MessageId};
///
...
///
/// ```rust
/// use crate::message::{wrap_message_with_metadata, MessageId, MessageMetadata};
///
/// let id = MessageId::new_uuid();
...
///
/// ```rust
/// use crate::message::{wrap_message, unwrap_message};
///
/// let msg = wrap_message(42);
...
///
/// ```rust
/// use crate::message::{wrap_message_with_generator, SequenceGenerator};
///
...
///
/// ```rust
/// use crate::message::{wrap_messages, SequenceGenerator};
///
/// let generator = SequenceGenerator::new();
...
///
/// ```rust,ignore
/// use crate::message::{wrap_message_with_shared_generator, SequenceGenerator};
/// use std::sync::Arc;
///
