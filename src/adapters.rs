...
///
/// ```rust,no_run
/// use crate::adapters::{MessageWrapper, RawProducer};
/// use crate::producer::Producer;
...
///
/// ```rust,ignore
/// use crate::adapters::{PayloadExtractor, RawTransformer};
/// use crate::message::Message;
/// use std::pin::Pin;
/// use tokio_stream::Stream;
/// use futures::StreamExt;
...
///
/// ```rust,ignore
/// use crate::adapters::{PayloadExtractorConsumer, RawConsumer};
/// use crate::message::Message;
/// use std::pin::Pin;
/// use tokio_stream::Stream;
///
